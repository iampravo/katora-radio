// ---------- static data & config ----------
// Pure data, no logic, no DOM. Safe to read, diff, and extend without
// touching any behavior in the other modules.
...
export const GIF_ROTATE_MS = 25000;
...
export const SLOT_MINUTES = 4; // nominal per-song scheduling slot, used only to pick the live starting point
export const SONG_VOLUME = 60; // 0-100, YouTube player's own scale
export const AMBIENT_VOLUME = 0.7; // 0-1, HTMLMediaElement scale — audible under the song, not competing with it
